...
<li class="js-shipping-list-item card mb-neg-1 radio-button-item p-3" data-store="shipping-calculator-item-{{ option.code }}">
            ...
            <div class="radio-button-label ml-1">
                ...
                <div class="radio-button-text row"> 
                    <div class="col font-small">
                        ...
                        {% if option.time %}
                            <div class="opacity-60 {% if option.suboptions is not empty or option.payment_rules or (option.method == 'pickup-point' and option.pickup_hours is not empty) %}mb-1{% endif %}" data-component="option.date">
