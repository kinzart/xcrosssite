<div class="{% if home_main_product %}pt-md-4 mt-md-2 pt-3{% else %}pt-md-3{% endif %}">
    ...
    <div class="price-container mb-3" data-store="product-price-{{ product.id }}" data-combined-discount="{{ product.isPromotionEligibleForCombinedDiscount ? 'true' : 'false' }}">
        {% if not is_subscription_only_product %}
            ...
            <div class="js-price-container">
                ...
                <span class="d-inline-flex align-items-center font-big">
    ...
    {{ component('gift-promotion-message', {
        container_classes: {
            container: 'pt-1 mb-4 font-small',
