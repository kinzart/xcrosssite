<div id="shoppingCartPage" data-minimum="{{ settings.cart_minimum_value }}" data-store="cart-page">
    ...
    <form action="{{ store.cart_url }}" method="post" class="visible-when-content-ready container mt-3 mb-5" data-store="cart-form" data-component="cart">
        ...
        {% if cart.items %}
            ...
            <div class="row">
                <div class="col-md-9">
                    ...
                    <div class="cart-row font-smallest text-transform mb-3 d-none d-md-block">
