                ...
                {% if link_expired %}
                    ...
                    <div class="mb-4">
                        {% if is_account_activation %}
                            <div class="font-big mb-1 font-weight-bold">{{ 'El link para activar tu cuenta expiró' | translate }}</div>
                            <div>{{ 'Contactanos para que te enviemos uno nuevo.' | translate }}</div>
                        {% else %}
                            <div class="font-big mb-1 font-weight-bold">{{ 'El link para cambiar tu contraseña expiró' | translate }}</div>
